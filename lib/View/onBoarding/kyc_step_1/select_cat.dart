import 'package:edushalaacademy/View/onBoarding/kyc_step_1/select_board.dart';
  ...
  get()async{
    ...
    setState(() {
      isloading = true;
       ...
       await _homeController.fetchCategoriesParent().then((value) {
         setState(() {
           isloading = false;
         });
       });
        ...
        child: Column(
          ...
          children: [
            ...
            LinearProgressIndicator(
              ...
              value:
                  0.25, // Adjust the value based on the progress of step three
            ),
            SizedBox(height: 41.h),
            Text(
                // _homeController.message??"Select Category",
              "Academics",
                  ...
                  children: [
                    Padding(
                      ...
                      child: GridView.builder(
                        itemCount: _homeController.subCategories.length,
                        shrinkWrap: true,
  ...
  Widget catList(BuildContext context,
    ...
    onTap: () {
      ...
      if(subCategory.containSubcategory == true){
        Get.to(()=>
            SelectBoardScreen(id: subCategory.id.toString(),isParent:widget.isParent),
