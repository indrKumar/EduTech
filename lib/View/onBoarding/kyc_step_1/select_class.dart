import 'package:edushalaacademy/View/onBoarding/kyc_step_1/select_subject.dart';
...
class SelectClass extends StatefulWidget {
  ...
  SelectClass({super.key, this.id, this.isParent});
...
class _SelectClassState extends State<SelectClass> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              child: Column(
                ...
                children: [
                  ...
                  LinearProgressIndicator(
                    ...
                    value:
                        0.75, // Adjust the value based on the progress of step three
                  ),
      ...
      bottomNavigationBar:
          containSubcategory == false ? _buildSubmitForReviewButton() : null,
    );
  }
    ...
    return GestureDetector(
      onTap: () {
        ...
        if (subCategory.containSubcategory == true) {
          Get.to(
            () => SelectSubjectPage(
                id: subCategory.id.toString(), isParent: widget.isParent),
