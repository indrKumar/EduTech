...
class _StudentsListsState extends State<StudentsLists> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: studentList.length > 0 ?SingleChildScrollView(
          child: Padding(
              ...
              child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        height: 20,
                                          ...
                                          child: ListView.builder(
                                            ...
                                            itemCount: studentList[index]["catdata"].length,
                                            shrinkWrap: true,
                                            itemBuilder: (context, itemIndex) {
                                              // Assuming the subjects are strings
                                              String subject = studentList[index]["catdata"][itemIndex]['name'];
                                              // Check if it's the first item to avoid adding a comma before the first subject
                                              if (itemIndex == 0) {
                                                return Text(subject, style: CustomTextStyles.bodySmallff00000010);
                                              } else {
                                                return Text(", $subject", style: CustomTextStyles.bodySmallff00000010);
                                              }
                                      ...
                                      // Row(children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: ListView.builder(
                                            scrollDirection: Axis.horizontal,
                                            itemCount: studentList[index]["Subjects"].length,
                                            shrinkWrap: true,
                                            itemBuilder: (context, itemIndex) {
                                              // Assuming the subjects are strings
                                              String subject = studentList[index]["Subjects"][itemIndex];
                                              // Check if it's the first item to avoid adding a comma before the first subject
                                              if (itemIndex == 0) {
                                                return Text(subject, style: CustomTextStyles.bodySmallff00000010);
                                              } else {
                                ...
                                GestureDetector(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.symmetric(
                                          horizontal: 10, vertical: 5),
                                      child: SvgPicture.asset(
                                        ImageConstant.imgDelete1LightBlueA400,
                                        height: 22,
                                        width: 22,
                                      ),
                                    ))
                  ...
                  ]))):const Center(child: Text("Please add new Student"),),
        ...
        CustomElevatedButton(
            onPressed: () {
              if(studentList.length >0 ){
                // if(
                Get.offAll(() =>  NearYouTutor(isMax: studentList.length >1?true:false));
              }else{
