  ...
  Widget build(BuildContext context) {
    return Scaffold(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                color: selectedIndex == index
                                    ? theme.primaryColor
                                    : Colors.grey
                                        .shade200, // Color based on selection
                              ),
                              // height: 30,
                              child: Padding(
                                ...
                                child: Center(
                                  child: Text(
                                    "Cycle ${index - 1}",
                                    // Display items starting from the last index
                                    style: TextStyle(
                                        color: selectedIndex == index
                                            ? Colors.white
                                            : Colors.black,
      ...
      floatingActionButton: CustomElevatedButton(
          width: 200.w,
          text: "Video Guide",leftIcon: const Padding(
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "30",
                        style: CustomTextStyles.titleMediumffffffffSemiBold,
                      ),
                      const SizedBox(
                        height: 5,
                      ),
                      Text(
                        "Total Hours",
                        style: CustomTextStyles.bodyMediumMontserratffffffff13,
                      ),
                    ],
                  ),
                ),
                      ...
                      Flexible(
                        child: SizedBox(
                          ...
                          child: Text(
                            "Hours Conducted",
                            style:
                                CustomTextStyles.bodyMediumMontserratffffffff13,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    regular,
                    style: CustomTextStyles.montserratBlack900Medium.copyWith(
                      color: appTheme.black900,
                    ),
                  ),
                ],
